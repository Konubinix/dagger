...
* Running ralph in a container
  ...
  #+begin_src bash :tangle (daggerlib-tangle-test "ralph_yml_valid") :comments no :padline no
  ...
  #+RESULTS[d622db5d58703e1fecf1101746b83abd3286e07a]: ralph_yml_valid

  #+BEGIN_SRC org :tangle (daggerlib-tangle-expected "ralph_yml_valid") :noweb yes :exports none :comments no :padline no
  <<ralph_yml_valid()>>
  #+END_SRC
  ...
  #+begin_src bash :tangle (daggerlib-tangle-test "log_filter_output") :comments no :padline no
  ralph-log-filter < tests/ralph_log_sample.txt 2>/dev/null | sed 's/\x1b\[[0-9;]*m//g'
  #+end_src

  #+RESULTS[70e8b89e03ad295a817bf07ed96f0208e5829e83]: log_filter_output

  #+BEGIN_SRC org :tangle (daggerlib-tangle-expected "log_filter_output") :noweb yes :exports none :comments no :padline no
  <<log_filter_output()>>
  #+END_SRC
