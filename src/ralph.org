...
* Running ralph in a container
  ...
  #+RESULTS[69a96f6ef58e5fcbb1011c184ded065a9ebbf400]: ralph_yml_valid
  : work.start
  : 2
  ...
  #+RESULTS[c138352f4e19bcf4c49b22d4dc9cb07b57ec07a6]: log_filter_output
  ...
  #+BEGIN_SRC org :tangle (daggerlib-tangle-expected "log_filter_output") :exports none :comments no :padline no
  [ralph] starting ralph...
  [ralph] ralph started (PID 16)
  [file] Read: /tmp/ralph-workdir/ralph.yml
  [tool] Bash: mkdir -p .ralph/agent
