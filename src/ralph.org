...
#+RESULTS[d622db5d58703e1fecf1101746b83abd3286e07a]: ralph_yml_valid-run

#+BEGIN_SRC org :tangle (expand-file-name "tests/expected/ralph_yml_valid" (locate-dominating-file default-directory ".git")) :noweb yes :exports none :comments no :padline no
<<ralph_yml_valid-run()>>
#+END_SRC
:end:
...
#+RESULTS: log_filter_output
:results:
#+NAME: log_filter_output-run
#+begin_src bash :exports code :eval no-export
ralph-log-filter < "${ROOT}/tests/ralph_log_sample.txt" 2>/dev/null | sed 's/\x1b\[[0-9;]*m//g'
#+end_src

#+RESULTS[70e8b89e03ad295a817bf07ed96f0208e5829e83]: log_filter_output-run

#+BEGIN_SRC org :tangle (expand-file-name "tests/expected/log_filter_output" (locate-dominating-file default-directory ".git")) :noweb yes :exports none :comments no :padline no
<<log_filter_output-run()>>
#+END_SRC
:end:
