...
class LibDevID(Scalar):
    """The `LibDevID` scalar type represents an identifier for an object
    of type LibDev."""


class LibID(Scalar):
    """The `LibID` scalar type represents an identifier for an object of
    type Lib."""
...
class Binding(Type):
    ...
    def as_lib(self) -> "Lib":
        """Retrieve the binding value, as type Lib"""
        _args: list[Arg] = []
        _ctx = self._select("asLib", _args)
        return Lib(_ctx)

    def as_lib_dev(self) -> "LibDev":
        """Retrieve the binding value, as type LibDev"""
        _args: list[Arg] = []
        _ctx = self._select("asLibDev", _args)
        return LibDev(_ctx)
...
class Env(Type):
    ...
    def with_lib_dev_input(self, name: str, value: "LibDev", description: str,) -> Self:
        """Create or update a binding of type LibDev in the environment
        ...
        name:
            The name of the binding
        value:
            The LibDev value to assign to the binding
        description:
            The purpose of the input
        """
        _args = [
        ...
        _ctx = self._select("withLibDevInput", _args)
        return Env(_ctx)

    def with_lib_dev_output(self, name: str, description: str) -> Self:
        """Declare a desired LibDev output to be assigned in the environment
        ...
        _ctx = self._select("withLibDevOutput", _args)
        return Env(_ctx)

    def with_lib_input(self, name: str, value: "Lib", description: str,) -> Self:
        """Create or update a binding of type Lib in the environment
        ...
        name:
            The name of the binding
        value:
            The Lib value to assign to the binding
        description:
            The purpose of the input
        """
        _args = [
        ...
        _ctx = self._select("withLibInput", _args)
        return Env(_ctx)

    def with_lib_output(self, name: str, description: str) -> Self:
        """Declare a desired Lib output to be assigned in the environment
        ...
        _ctx = self._select("withLibOutput", _args)
        return Env(_ctx)
...
class Lib(Type):
    ...
    def alpine(self, *, distro_packages: list[str] | None = None,) -> Container:
        """
        Alpine with timezone set and optional extra packages.
        """
        _args = [
            Arg("distroPackages", [] if distro_packages is None else distro_packages, []),
        ]
        _ctx = self._select("alpine", _args)
        return Container(_ctx)

    def alpine_python(self, *, distro_packages: list[str] | None = None,) -> Container:
        """
        ...
        _ctx = self._select("alpinePython", _args)
        return Container(_ctx)

    def alpine_python_user_venv(self, *, distro_packages: list[str] | None = None, groups: list[str] | None = None, pip_packages: list[str] | None = None, work_dir: str = '/app',) -> Container:
        """
        Alpine with python, user, and a virtualenv.
        """
        _args = [
            Arg("distroPackages", [] if distro_packages is None else distro_packages, []),
            Arg("groups", [] if groups is None else groups, []),
            Arg("pipPackages", [] if pip_packages is None else pip_packages, []),
            Arg("workDir", work_dir, '/app'),
        ]
        _ctx = self._select("alpinePythonUserVenv", _args)
        return Container(_ctx)

    def alpine_set_tz(self, ctr: Container) -> Container:
        """
        ...
        _ctx = self._select("alpineSetTz", _args)
        return Container(_ctx)

    def alpine_tz(self) -> Directory:
        """
        Extract /etc/localtime and /etc/timezone from Alpine as artifacts.
        """
        _args: list[Arg] = []
        _ctx = self._select("alpineTz", _args)
        return Directory(_ctx)

    def alpine_user(self, *, distro_packages: list[str] | None = None, groups: list[str] | None = None, uid: int = 1000,) -> Container:
        """
        ...
        _ctx = self._select("alpineUser", _args)
        return Container(_ctx)

    def as_user(self, ctr: Container, *, uid: int = 1000, username: str | None = None,) -> Container:
        """
        ...
        _args = [
            Arg("ctr", ctr),
            Arg("uid", uid, 1000),
            Arg("username", username, None),
        ]
        _ctx = self._select("asUser", _args)
        return Container(_ctx)

    def debian(self, *, distro_packages: list[str] | None = None,) -> Container:
        """
        Debian slim with timezone set, no auto-install, and optional extra
        packages.
        """
        _args = [
            Arg("distroPackages", [] if distro_packages is None else distro_packages, []),
        ]
        _ctx = self._select("debian", _args)
        return Container(_ctx)

    def debian_apt_cleanup(self, ctr: Container) -> Container:
        """
        Clean apt caches.
        ...
        _ctx = self._select("debianAptCleanup", _args)
        return Container(_ctx)

    def debian_localtime(self) -> File:
        """
        Extract the localtime file from a Debian container.
        """
        _args: list[Arg] = []
        _ctx = self._select("debianLocaltime", _args)
        return File(_ctx)

    def debian_no_auto_install(self, ctr: Container) -> Container:
        """
        ...
        _ctx = self._select("debianNoAutoInstall", _args)
        return Container(_ctx)

    def debian_python_user_venv(self, *, distro_packages: list[str] | None = None, groups: list[str] | None = None, pip_packages: list[str] | None = None, work_dir: str = '/app',) -> Container:
        """
        ...
        _ctx = self._select("debianPythonUserVenv", _args)
        return Container(_ctx)

    def debian_set_tz(self, ctr: Container) -> Container:
        """
        ...
        _ctx = self._select("debianSetTz", _args)
        return Container(_ctx)

    def debian_user(self, *, distro_packages: list[str] | None = None,) -> Container:
        """
        ...
        _ctx = self._select("debianUser", _args)
        return Container(_ctx)
    ...
    def dind_container(self, *, base: Container | None = None, src: Directory | None = None,) -> Container:
        """
        ...
        _ctx = self._select("dindContainer", _args)
        return Container(_ctx)

    def dind_with_docker(self, cmd: str, *, ctr: Container | None = None,) -> Container:
        """
        Run a shell command inside the container with dockerd available.

        Handles cgroup v2 setup, tmpfs for /var/lib/docker,
        and dockerd lifecycle. If no container is provided, uses
        dind_container().
        ...
        _ctx = self._select("dindWithDocker", _args)
        return Container(_ctx)

    def distroless_debian(self) -> Container:
        """
        Distroless static with timezone set.
        """
        _args: list[Arg] = []
        _ctx = self._select("distrolessDebian", _args)
        return Container(_ctx)

    def distroless_python3_debian(self) -> Container:
        """
        Distroless python3 with timezone set.
        """
        _args: list[Arg] = []
        _ctx = self._select("distrolessPython3Debian", _args)
        return Container(_ctx)

    def distroless_set_tz(self, ctr: Container) -> Container:
        """
        Copy timezone artifacts into a distroless container (uses
        Lib.timezone).
        ...
        _ctx = self._select("distrolessSetTz", _args)
        return Container(_ctx)

    def flask_venv(self, *, pip_packages: list[str] | None = None,) -> Directory:
        """
        ...
        _ctx = self._select("flaskVenv", _args)
        return Directory(_ctx)

    async def id(self) -> LibID:
        """A unique identifier for this Lib.
        ...
        _args: list[Arg] = []
        _ctx = self._select("id", _args)
        return await _ctx.execute(LibID)

    def pip_tools(self) -> Container:
        """
        Python Alpine with pip-tools and a default user.
        """
        _args: list[Arg] = []
        _ctx = self._select("pipTools", _args)
        return Container(_ctx)

    def python_user_venv(self, ctr: Container, *, groups: list[str] | None = None, pip_packages: list[str] | None = None, work_dir: str = '/app',) -> Container:
        """
        Add a user, workdir, and virtualenv to a container that already has
        Python.
        ...
        _ctx = self._select("pythonUserVenv", _args)
        return Container(_ctx)

    def python_venv(self, ctr: Container, base: str, *, pip_packages: list[str] | None = None,) -> Container:
        """
        Create a Python venv with --system-site-packages and optionally
        install packages.
        ...
        _ctx = self._select("pythonVenv", _args)
        return Container(_ctx)

    def ralph(self, claude_credentials: "Secret", *, src: Directory | None = None, ctr: Container | None = None, distro_packages: list[str] | None = None, username: str | None = None, git_email: str = 'ralph@localhost', git_name: str = 'Ralph', ralph_args: str = '', work_dir: str = '/tmp/ralph-workdir', dagger_runner_host: str = '', consul_addr: str = '', consul_key: str = 'ralph/dagger/status', ralph_yml: File | None = None, plan_md: File | None = None, todo_org: File | None = None,) -> Directory:
        """
        Run ralph orchestrator in a container and return the workdir with
        patches.
        ...
        """
        _args = [
            Arg("claudeCredentials", claude_credentials),
            Arg("src", src, None),
            Arg("ctr", ctr, None),
            Arg("distroPackages", [] if distro_packages is None else distro_packages, []),
            Arg("username", username, None),
            Arg("gitEmail", git_email, 'ralph@localhost'),
            Arg("gitName", git_name, 'Ralph'),
            Arg("ralphArgs", ralph_args, ''),
            Arg("workDir", work_dir, '/tmp/ralph-workdir'),
            Arg("daggerRunnerHost", dagger_runner_host, ''),
            Arg("consulAddr", consul_addr, ''),
            Arg("consulKey", consul_key, 'ralph/dagger/status'),
            Arg("ralphYml", ralph_yml, None),
            Arg("planMd", plan_md, None),
            Arg("todoOrg", todo_org, None),
        ]
        _ctx = self._select("ralph", _args)
        return Directory(_ctx)

    def setup_user(self, ctr: Container, *, uid: int = 1000, username: str | None = None, sudoer: bool = False, shell: str = '/bin/sh', groups: list[str] | None = None,) -> Container:
        """
        ...
        _args = [
            ...
            Arg("uid", uid, 1000),
            Arg("username", username, None),
            Arg("sudoer", sudoer, False),
            Arg("shell", shell, '/bin/sh'),
            Arg("groups", [] if groups is None else groups, []),
        ]
        _ctx = self._select("setupUser", _args)
        return Container(_ctx)

    def use_user(self, ctr: Container, *, uid: int = 1000, username: str | None = None, sudoer: bool = False, groups: list[str] | None = None,) -> Container:
        """
        ...
        _ctx = self._select("useUser", _args)
        return Container(_ctx)
...
class LibDev(Type):
    ...
    async def id(self) -> LibDevID:
        """A unique identifier for this LibDev.
        ...
        _args: list[Arg] = []
        _ctx = self._select("id", _args)
        return await _ctx.execute(LibDevID)

    def run(self, *, source: Directory | None = None) -> Directory:
        """
    ...
    def tangle(self, *, source: Directory | None = None) -> Directory:
        """
        ...
        _ctx = self._select("tangle", _args)
        return Directory(_ctx)

    async def test(self, *, source: Directory | None = None) -> str:
        """
        Run the test suite.
...
class Client(Root):
    ...
    def current_workspace(self, *, skip_migration_check: bool | None = False,) -> "Workspace":
    ...
    def lib(self, *, alpine_version: str = '3.23', debian_version: str = '13', debian_min_version: str = '2', pip_tools_python_version: str = '3.12', default_username: str = 'sam', timezone: str = 'Europe/Paris', dev_debian_image: str = 'debian:bookworm-slim', dind_ubuntu_image: str = 'ubuntu:24.04',) -> Lib:
        _args = [
            Arg("alpineVersion", alpine_version, '3.23'),
            Arg("debianVersion", debian_version, '13'),
            Arg("debianMinVersion", debian_min_version, '2'),
            Arg("pipToolsPythonVersion", pip_tools_python_version, '3.12'),
            Arg("defaultUsername", default_username, 'sam'),
            Arg("timezone", timezone, 'Europe/Paris'),
            Arg("devDebianImage", dev_debian_image, 'debian:bookworm-slim'),
            Arg("dindUbuntuImage", dind_ubuntu_image, 'ubuntu:24.04'),
        ]
        _ctx = self._select("lib", _args)
        return Lib(_ctx)
    ...
    def load_lib_dev_from_id(self, id: LibDevID) -> LibDev:
        """Load a LibDev from its ID."""
        _args = [
            Arg("id", id),
        ]
        _ctx = self._select("loadLibDevFromID", _args)
        return LibDev(_ctx)

    def load_lib_from_id(self, id: LibID) -> Lib:
        """Load a Lib from its ID."""
        _args = [
            Arg("id", id),
        ]
        _ctx = self._select("loadLibFromID", _args)
        return Lib(_ctx)
