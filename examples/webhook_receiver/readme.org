...
: Initialized module webhook_receiver in /work/examples/webhook_receiver
...
#+begin_src python :tangle .dagger/src/webhook_receiver/main.py :noweb yes
...
* Packaging the app in a container
  ...
  #+RESULTS[c9f0eca6efec78e31fa8616a78de49e4e1490ce4]: flask_app_loads
  : ['/health', '/webhook']
...
* Running with gunicorn in production
  ...
  #+RESULTS[f2029182ee7633550eb2c0b1674022429ac0763a]: flask_gunicorn_check
  : gunicorn config ok
