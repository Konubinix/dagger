...
* Module context
  ...
  module context.  Every file sent as module source is part of the
  cache key: touching /any/ non-ignored file invalidates the cache and
  forces a full re-run.  Only files that a =dagger call= function
  actually needs should be included.
